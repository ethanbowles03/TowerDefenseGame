...
public class EffectWater implements Animatable{
	//Field
	...
	public EffectWater(GameState state, Point origin, Point dest) {
		this.state = state;
		this.origin = origin;
		this.dest = dest;
	...
	public void draw(Graphics g, GameView v) {
		BufferedImage waterDrop = ResourceLoader.getLoader().getImage("WaterDrop.png");
		v.drawCenteredImage(g,"WaterDrop.png", (int) x, (int) y, 1.0);
	}
}
